...
export const FormConnexionVendeur = () => {
    ...
    return (
        <div className='d-flex justify-content-center container mx-auto row'>
            <h3 className={`${styles.title} text-center`}> Connexion</h3>
            <form className='col-md-6 col-lg-4 align-items-cente container' onSubmit={(e)=> formConnexionVendeur(e, formdata, setIsLoad, setFormdata, router)}>
                <div className="mb-3">
                    <label>Email</label>
                ...
                <div>
                    <p className='text-center'>Vous êtes nouveau ? <Link href={'/pages/auth/inscription-vendeur'} className='text-decoration-none'>créer un compte</Link></p> 
                </div>
            </form>
        </div>
    )
